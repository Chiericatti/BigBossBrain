...
class HardViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        hardStartButton.setImage(#imageLiteral(resourceName: "icons8-play-filled-50"), for: .normal)
...
//            print(GameController.shared.gameTypeTwoButtonsTag)
    ...
    func createVictoryAlert() {
        ...
        if GameController.shared.gameType == 1 {
            ...
            let alert = UIAlertController(title: GameController.shared.randomAlertTitleClassic, message: "- 3 points added to Classic\n - 3 points added to King of Points.", preferredStyle: .alert)
            ...
            let alert = UIAlertController(title: GameController.shared.randomAlertTitlePro, message: "- 3 points added to Professional\n - 6 points added to King of Points.", preferredStyle: .alert)
